...
my $routes = [
	...
	["GET", "/ui", sub {
		return res_template("lib/templates/index");
	}],

	["GET", "/ui/upload", sub {
		return res_template("lib/templates/upload");
	}],
	...
	["POST", "/ui/data", sub {
		...
		return res_template("lib/templates/file");
	}],
	...
	["GET", "/style.css", sub {
		return res_file("lib/static/style.css");
	}],

	["GET", "/favicon.ico", sub {
		return res_file("lib/static/favicon.ico");
	}],
